...
#+html: <img align="center" src="images/provisioning.png">
...
- PyCS --- Python Command Services: :: \\
  ...
  Python virtual environment of PyCS is at file:/bisos/venv/py3/bisos3. Many
  PyCS scripts are housed in file:/bisos/core/bpip/bin/.
...
- ICM --- Bash Interactive Command Modules: :: \\
  ...
  BISOS ICMs primarily reside in file:/bisos/core/bsip/bin/.
...
- Blee Libraries: :: \\
  ...
  --- , provides an overview of Blee.

  Within the BISOS platform, Blee libraries reside in file:/bisos/blee/env3/.
...
- LCNT --- Libre Content Development and Publication: :: \\
  ...
  Section [sec:BISOSContentGenerationandSelf-Publication] --- , provides
  an overview of LCNT.
...
Section [[#sec:CollaborativeOrg-ModeEnhancedEmacsGeneralizedAuthorship(COMEEGA)][[sec:CollaborativeOrg-ModeEnhancedEmacsGeneralizedAuthorship(COMEEGA)]]]
